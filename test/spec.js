...
describe('Module "car"', function () {
	...
	describe('pessangers', function () {
		...
		it('are not landed if one more passengers are put than possible', function () {
			var times = car.seats * 2;
			while (times--) {
				car.put()
			}
	...
	describe('when drived', function () {
		...
		it('doesn\'t change speed if additional passenger is put', function () {
			var speed = 85
			car.put()
			car.drive(speed)
			car.put()
		...
		it('doesn\'t change speed if some passenger is landed', function () {
			var speed = 85
			car.put()
			car.put()
			car.drive(speed)
		...
		it('stopped if all passengers are landed', function () {
			var speed = 20
			car.put()
			car.drive(speed)
			car.land()
